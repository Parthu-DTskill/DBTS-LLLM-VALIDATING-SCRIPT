...
class LLMTestingClient:
    ...
    def __init__(self, scenario_id):
        ...
        self.client = Opik()
        self.dataset = self.client.get_or_create_dataset(name="DBTS Evaluation Dataset", description="Dataset for evaluating DBTS scenarios")
        self.hallucination_metric = Hallucination(model=GenericCompatibleModel(model_name="gemma2-9b-it", api_key="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", model_provider="groq"))
        self.answerRelevance_metric = AnswerRelevance(model=GenericCompatibleModel(model_name="gemma2-9b-it", api_key="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", model_provider="groq"))
...
if __name__ == "__main__":
    client = LLMTestingClient(scenario_id="603937b4-d5b8-4d04-86d7-a59ddcd97f1d")
